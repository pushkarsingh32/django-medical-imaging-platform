"""
Django settings for Medical Imaging Platform.
...
MIDDLEWARE = [
    ...
    'config.correlation_middleware.CorrelationIdMiddleware',  # Correlation ID for tracing
    'corsheaders.middleware.CorsMiddleware',  # CORS - must be before CommonMiddleware
    'django.contrib.sessions.middleware.SessionMiddleware',
    'django.middleware.common.CommonMiddleware',
    'config.middleware.DisableCSRFForAllauthMiddleware',  # Disable CSRF for allauth headless
...
HEADLESS_ADAPTER = 'config.adapters.CustomHeadlessAdapter'
