...
class PatientReportGenerator:
    ...
    def add_footer(self):
        ...
        This document contains private health information protected by applicable privacy laws.<br/>
        Unauthorized disclosure or reproduction is strictly prohibited.<br/><br/>
        Report generated: {datetime.now().strftime("%B %d, %Y at %I:%M %p")}<br/>
        MRN: {self.patient.medical_record_number} | {self.patient.hospital.name}
        </font>
        </para>
        """
