      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
        <div className="text-center">
          <h1 className="text-5xl font-extrabold text-gray-900 sm:text-6xl md:text-7xl">
            <span className="block">Django + Next.js</span>
            <span className="block text-blue-600">Authentication</span>
          </h1>
          <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
            Fullstack authentication using Django-Allauth Headless API with Next.js frontend
          </p>
                    ...
                    <div className="ml-5 w-0 flex-1">
                      <dl>
                        ...
                        <dd className="text-sm text-gray-900 mt-1">
                          Django-Allauth with session tokens
                        </dd>
                      </dl>
                    </div>
                  </div>
