...
export default function EditPatientPage() {
  ...
  useEffect(() => {
    if (patient) {
      setFormData({
        ...
        hospital: patient.hospital ? String(patient.hospital) : '',
      });

      if (patient.date_of_birth) {
        setDateOfBirth(parseISO(patient.date_of_birth));
      }
    }
  }, [patient]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const submitData: Partial<CreatePatientData> = {
    ...
    try {
      await updatePatient.mutateAsync({ id: patientId, data: submitData });
  ...
  // Debug: Log current form data in render
  console.log('Current formData in render:', formData);
  console.log('Patient data in render:', patient);
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">Update patient record for {patient.full_name}</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit}>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Select
                    key={`hospital-${patient?.id}-${formData.hospital}`}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Select
                    key={`gender-${patient?.id}-${formData.gender}`}
          ...
          <div className="flex gap-4 mt-6">
            <Button type="submit" size="lg" disabled={updatePatient.isPending}>
